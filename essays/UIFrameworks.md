...
layout: essay
type: essay
title: "From Scratch to Strapped"
...
<img width="300px" class="rounded float-start pe-4" src="../img/UIFrameworks/meme.jpg">
...
### Looking ahead
I can see the value of using UI frameworks to make common things in website design, such as navigation bars, buttons, and responsive layouts, much easier to implement. I appreciate all the frontends that I interact with on a daily basis, because I now understand the amount of design work and testing that goes into making a user-friendly experience. I never truly understood the effort and painstaking attention to detail required to create a polished UI that’s both functional and visually appealing. I’m curious about exploring other frameworks like React and seeing how they differ from Bootstrap 5 in terms of flexibility, performance, and workflow.
